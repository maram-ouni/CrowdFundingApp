                                      ...
                                      child: snapshot.data['collabJobs'][index]
                                          ...
                                          ? ElevatedButton(
                                              style: ElevatedButton.styleFrom(
                                                  elevation: 0, backgroundColor: Theme.of(context)
                                                      .primaryColor,
...
Future<dynamic> getAllCollabJobs(String token , String campID) async {
  ...
  var request = http.Request('GET',
      Uri.parse('http://192.168.1.18:8080/api/getAllCollabJobForACamp/' + campID));
...
Future<dynamic> sendCollabRequest(String token , String collabId) async {
  ...
  var request = http.Request(
      'POST', Uri.parse('http://192.168.1.18:8080/api/sendRequestToCollab'));
