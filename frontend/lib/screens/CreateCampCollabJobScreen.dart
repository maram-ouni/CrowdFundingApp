...
class _CreateCampCollabJobScreenState extends State<CreateCampCollabJobScreen> {
  ...
  Widget build(BuildContext context) {
    campData = ModalRoute.of(context)?.settings.arguments as Map<dynamic, dynamic>;
    print(campData);
    return Scaffold(
                ...
                Container(
                  ...
                  child: ElevatedButton(
                    ...
                    style: ElevatedButton.styleFrom(
                      elevation: 0, backgroundColor: Color.fromRGBO(230, 230, 230, 1),
...
Future<dynamic> newCollabJobForCamp(
  ...
  var request = http.Request(
      'POST', Uri.parse('http://192.168.1.18:8080/api/newCollabJobForCamp'));
